...
@pytest.mark.parametrize(
    "model",
    [
        "bedrock/arn:aws:bedrock:eu-west-1:6767:inference-profile/eu.amazon.nova-2-lite-v1:0",
        "bedrock/converse/arn:aws:bedrock:eu-west-1:6767:inference-profile/eu.amazon.nova-2-lite-v1:0",
    ],
)
